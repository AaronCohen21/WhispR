...
public class DefaultPanel {
    ...
    public DefaultPanel(JPanel parent) {
        this.parent = parent;
        defaultTextColor = nameLabel.getForeground();
        ...
        nameField.addActionListener((e -> joinRoom()));
    ...
    private void joinRoom() {
        ...
        if (!validRoom) {
            ...
            if (!nameField.getText().equals("")) {
                ...
                ChatNetworker chatNetworker = new ChatNetworker(parent, chatPanel, Integer.parseInt(roomField.getText()), nameField.getText());
                chatNetworker.start();
            }
        }
    }
